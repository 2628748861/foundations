package com.plugin.foundation.library.widght;
...
public class Toasty {
    ...
    public static void showTip(Context context, String message){
        ...
        ViewGroup viewGroup=(ViewGroup) LayoutInflater.from(context).inflate(R.layout.foundation_layout_tip_toast,null,false);
