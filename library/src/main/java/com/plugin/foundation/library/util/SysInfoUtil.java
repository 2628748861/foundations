...
public class SysInfoUtil {
     ...
     * @return
     */
    public static boolean isProcessExist(Context mContext, String processName)
    {
        ...
        for (ActivityManager.RunningAppProcessInfo processInfo:list)
        {
            if(pid==processInfo.pid)
            {
                ...
                if(!TextUtils.isEmpty(currentProcessName)&&processName.equals(currentProcessName))
                {
                    return true;
                }
            }
...
//        String packageName = context.getApplicationContext().getPackageName();
    ...
    public static final boolean isServiceRuning(Context context,String packageName) {
        ...
        for (int i = 0; i < serviceList.size(); i++) {
            ...
            if (runningClassName.contains(packageName)) {
                isRunning = true;
                break;
            }
        }
